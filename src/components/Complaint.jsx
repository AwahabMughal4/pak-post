...
const Complaints = () => {
  ...
  return (
    ...
    <div className="container mx-auto p-4 space-y-4">
      <h2 className="text-xl font-semibold mb-4 text-center justify-center mt-4">Create Complaint</h2>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="flex space-x-4">
          ...
          <div className="w-[50%]">
            <label htmlFor="preferModeOfReply" className="block text-sm font-medium">
        ...
        <div className="flex space-x-4">
          ...
          <div className="w-[50%]">
            <label htmlFor="complainantMobile" className="block text-sm font-medium">
        ...
        <div className="flex space-x-4">
          ...
          <div className="w-[50%]">
            <label htmlFor="complaintReason" className="block text-sm font-medium">
              Complaint Reason:
            </label>
            <select
              id="complaintReason"
        ...
        <div className="flex space-x-4">
          ...
          <div className="w-[80%]">
            <label htmlFor="bookingOffice" className="block text-sm font-medium">
              Booking Office:
            </label>
            <input
              type="text"
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <div>
              <label htmlFor="senderAddress" className="block text-sm font-medium">
                Address:
              </label>
              <textarea
                id="senderAddress"
            ...
            <div>
              <label htmlFor="senderCity" className="block text-sm font-medium">
                City:
              </label>
              <select
                id="senderCity"
            ...
            <div>
              <label htmlFor="senderTel" className="block text-sm font-medium">
                Tel:
              </label>
              <input
                type="tel"
            ...
            <div>
              <label htmlFor="senderMobile" className="block text-sm font-medium">
                Mobile:
              </label>
              <input
                type="tel"
          ...
          <div>
            ...
            <div>
              <label htmlFor="addresseeName" className="block text-sm font-medium">
                Name:
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="addresseeAddress" className="block text-sm font-medium">
                Address:
              </label>
              <textarea
                id="addresseeAddress"
            ...
            <div>
              <label htmlFor="addresseeCity" className="block text-sm font-medium">
                City:
              </label>
              <select
                id="addresseeCity"
            ...
            <div>
              <label htmlFor="addresseeEmail" className="block text-sm font-medium">
                Email:
              </label>
              <input
                type="email"
            ...
            <div>
              <label htmlFor="addresseeTel" className="block text-sm font-medium">
                Tel:
              </label>
              <input
                type="tel"
            ...
            <div>
              <label htmlFor="addresseeMobile" className="block text-sm font-medium">
                Mobile:
              </label>
              <input
                type="tel"
  ...
  <div className="flex flex-row mr-28 ">
      <label htmlFor="remarks" className="block text-sm font-medium mb-1 mr-2 mt-10">
        Remarks:
      </label>
      <textarea
        id="remarks"
  ...
  <div className="w-[90%]">
    <label htmlFor="district" className="block text-sm font-medium mb-1 mt-10">
      District:
    </label>
    <select
      id="district"
  ...
  <div className="w-[90%]">
    <label htmlFor="tehsil" className="block text-sm font-medium mb-1 mt-10">
      Tehsil:
    </label>
    <select
      id="tehsil"
  ...
  <div className="w-[90%]">
    <label htmlFor="location" className="block text-sm font-medium mb-1 mt-10">
      Location:
    </label>
    <select
      id="location"
...
<div className="flex flex-row space-x-4">
  <div className="w-[80%]">
    <label htmlFor="attachment" className="block text-sm font-medium mb-1 mt-10">
    Attach file(if any):
    </label>
    <input
      type="file"
