    ...
    <div className="bg-gradient-to-r from-gray-100 to-gray-200 min-h-screen py-8">
      <div className="container mx-auto ">
        <div className="bg-red-600 text-white p-4 mb-8 rounded-lg text-center">
          ...
          <p className=" mt-2">
            Please fill out the following form with your complaint.<br></br> We
            will review your request and follow up with you as soon as possible
          </p>
        </div>
        <div className=" flex justify-center">
          <form
            onSubmit={handleSubmit}
            className="bg-white p-8 rounded-lg shadow-lg space-y-6 w-[70%]"
          >
            ...
            <div className="flex flex-row mr-28 ">
              <label
                htmlFor="remarks"
                className="block text-lg f font-serif mb-1 mr-2 mt-10"
              >
                Remarks:
              </label>
              <textarea
            ...
            <div className="flex flex-row space-x-4">
              <div className="w-[90%]">
                <label
                  htmlFor="district"
                  className="block text-lg font-sarif mb-1 mt-10"
                >
                  District:
                </label>
                <select
