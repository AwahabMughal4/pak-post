...
export default function Stamps() {
  ...
  return (
    <div className="w-[100%]">
      ...
      <Box
        ml={{ base: isSidebarOpen ? "0" : "auto", md: "0" }}
        mt={{ base: isSidebarOpen ? "0" : "auto", md: "3" }}
        p="1rem"
        w={{ base: "100%", md: "100%" }}
        border="1px"
...
const SidebarContent = ({ isOpen, onClose, ...rest }) => {
  return (
    <Box
      ...
      borderColor={useColorModeValue("gray.200", "gray.700")}
      w={{ base: "60%", md: "100%" }}
      h={{ base: "65rem", md: "4rem" }}
      shadow={{ base: "dark-lg", md: "none" }}
      {...rest}
      overflow="scroll" // Hide the scrollbar by setting overflow to hidden
      css={{
        "&::-webkit-scrollbar": {
    ...
    >
      <Flex ml={"1rem"} alignItems="center" justifyContent="center">
        <Text
          fontSize="2xl"
...
const Contacts = () => {
  return (
    <div>
      {/* //div for button 2 */}
      <div id="2006" className="pt-[9rem] mt-[-9rem] ">
        <Heading
          textAlign={"center"}
          color={"white"}
          bgColor={"#ed1b24"}
      ...
      {/* //div for button 3 */}
      <div id="2007" className="pt-[9rem] mt-[-9rem]">
        <Heading
          textAlign={"center"}
          color={"white"}
          bgColor={"#ed1b24"}
      ...
      {/* //div for button 4 */}
      <div id="2008" className="pt-[9rem] mt-[-9rem]">
        <Heading
          textAlign={"center"}
          color={"white"}
          bgColor={"#ed1b24"}
        ...
        {/* -----------------------Button 5----------------------- */}
        {/* //b5 */}
        <div id="2009" className="pt-[9rem] mt-[-9rem]">
          <Heading
            textAlign={"center"}
            color={"white"}
            bgColor={"#ed1b24"}
        ...
        {/* //div for button 6 */}
        <div id="2010" className="pt-[9rem] mt-[-9rem]">
          <Heading
            textAlign={"center"}
            color={"white"}
            bgColor={"#ed1b24"}
        ...
        {/* //div for button 7 */}
        <div id="2011" className="pt-[9rem] mt-[-9rem]">
          <Heading
            textAlign={"center"}
            color={"white"}
            bgColor={"#ed1b24"}
        ...
        {/* //div for button 8 */}
        <div id="2012" className="pt-[9rem] mt-[-9rem]">
          <Heading
            textAlign={"center"}
            color={"white"}
            bgColor={"#ed1b24"}
        ...
        {/* -----------------------b9------------------------------------ */}
        <div id="2013" className="pt-[9rem] mt-[-9rem]">
          <Heading
            textAlign={"center"}
            color={"white"}
            bgColor={"#ed1b24"}
        ...
        {/* //div for button 10 */}
        <div id="2014" className="pt-[9rem] mt-[-9rem]">
          <Heading
            textAlign={"center"}
            color={"white"}
            bgColor={"#ed1b24"}
        ...
        {/* //div for button 11 */}
        <div id="2015" className="pt-[9rem] mt-[-9rem]">
          <Heading
            textAlign={"center"}
            color={"white"}
            bgColor={"#ed1b24"}
        ...
        {/* //div for button 12 */}
        <div id="2016" className="pt-[9rem] mt-[-9rem]">
          <Heading
            textAlign={"center"}
            color={"white"}
            bgColor={"#ed1b24"}
        ...
        {/* ------------------------------------------------------- */}
        {/* ===================2017========================= */}
        <div id="2017" className="pt-[9rem] mt-[-9rem]">
          <Heading
            textAlign={"center"}
            color={"white"}
            bgColor={"#ed1b24"}
        ...
        {/* ===================2018========================= */}
        <div id="2018" className="pt-[9rem] mt-[-9rem]">
          <Heading
            textAlign={"center"}
            color={"white"}
            bgColor={"#ed1b24"}
        ...
        {/* -----------------------2019------------------------------------ */}
        <div id="2019" className="pt-[9rem] mt-[-9rem]">
          <Heading
            textAlign={"center"}
            color={"white"}
            bgColor={"#ed1b24"}
        ...
        {/* //div for button 2020 */}
        <div id="2020" className="pt-[9rem] mt-[-9rem]">
          <Heading
            textAlign={"center"}
            color={"white"}
            bgColor={"#ed1b24"}
        ...
        {/* //div for button 2021 */}
        <div id="2021" className="pt-[9rem] mt-[-9rem]">
          <Heading
            textAlign={"center"}
            color={"white"}
            bgColor={"#ed1b24"}
        ...
        {/* //div for button 2022 */}
        <div id="2022" className="pt-[9rem] mt-[-9rem]">
          <Heading
            textAlign={"center"}
            color={"white"}
            bgColor={"#ed1b24"}
        ...
        {/* //div for button 2022 */}
        <div id="2023" className="pt-[9rem] mt-[-9rem]">
          <Heading
            textAlign={"center"}
            color={"white"}
            bgColor={"#ed1b24"}
