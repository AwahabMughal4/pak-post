        ...
        <Flex flexWrap="wrap" gridGap={6} justify="center">
          ...
          <Link to="/cod">
            <Card
              ...
              description={'COD system pays for articles upon receipt and recovers supplier values.'}
          ...
          <Link to="/sdd">
            <Card
              ...
              description={'Fast same-day delivery service for your urgent shipment needs.'}
          ...
          <Link to="/umson">
            <Card
              ...
              icon={<Image src={umsimage} alt="EMS Icon" w={10} h={10} />}
              description={'Overnight service delivers quickly within a short time frame.'}
